...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	LifecycleProcessor getLifecycleProcessor() throws IllegalStateException {
		if (this.lifecycleProcessor == null) {
			throw new IllegalStateException("LifecycleProcessor not initialized - "
					                                + "call 'refresh' before invoking lifecycle methods via the "
					                                + "context: " + this);
		}
	...
	protected void initPropertySources() {
		...
		System.out.println("initPropertySources 空实现");
	}
	...
	protected void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) {
		System.out.println("postProcessBeanFactory 空实现");
	}
	...
	protected void initMessageSource() {
		...
		if (beanFactory.containsLocalBean(MESSAGE_SOURCE_BEAN_NAME)) {
			...
			if (logger.isDebugEnabled()) {
				logger.debug(
						"Unable to locate MessageSource with name '" + MESSAGE_SOURCE_BEAN_NAME + "': using default ["
								+ this.messageSource + "]");
			}
		}
	}
	...
	protected void initApplicationEventMulticaster() {
		...
		if (beanFactory.containsLocalBean(APPLICATION_EVENT_MULTICASTER_BEAN_NAME)) {
			this.applicationEventMulticaster = beanFactory
	...
	protected void finishBeanFactoryInitialization(ConfigurableListableBeanFactory beanFactory) {
		...
		if (beanFactory.containsBean(CONVERSION_SERVICE_BEAN_NAME) && beanFactory
