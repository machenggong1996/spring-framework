...
public abstract class AbstractAutoProxyCreator extends ProxyProcessorSupport
	...
	protected boolean isInfrastructureClass(Class<?> beanClass) {
		boolean retVal =
				Advice.class.isAssignableFrom(beanClass) || Pointcut.class.isAssignableFrom(beanClass) || Advisor.class
						.isAssignableFrom(beanClass) || AopInfrastructureBean.class.isAssignableFrom(beanClass);
	...
	protected TargetSource getCustomTargetSource(Class<?> beanClass, String beanName) {
		...
		if (this.customTargetSourceCreators != null && this.beanFactory != null && this.beanFactory
